...
var lodash_ = __webpack_require__(34);
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    dispose: function dispose() {
      ...
      if (precision) {
        value = Object(lodash_["ceil"])(value, precision);
      }

      var integer = String(value).split('.')[0];
      var decimals = String(value).split('.')[1] || (precision ? Object(lodash_["fill"])(Array(precision), 0).join('') : '');
      var result = 0;
